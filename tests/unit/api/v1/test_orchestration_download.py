"""Tests for POST /api/v1/orchestration/download endpoint (Story 3.1 - RED phase)."""
...
class TestPostOrchestrationDownload:
...
class TestResponseTime:
    ...
    def test_download_responds_under_500ms(
        ...
        start = time.time()
        response = client.post("/api/v1/orchestration/download", json={})
