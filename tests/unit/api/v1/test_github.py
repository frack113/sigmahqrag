...
class TestGitHubApiV1Get:
    ...
    def test_list_repos_with_metadata_success(self, client):
        ...
        with (
            patch("src.api.v1.base.repo_router.list_repos", return_value=mock_repos),
            patch(
            ...
            patch("src.api.v1.base.repo_router.is_repo_outdated", return_value=False),
            patch(
    ...
    def test_list_repos_with_metadata_outdated(self, client):
        ...
        with (
            ...
            patch("src.api.v1.base.repo_router.is_repo_outdated", return_value=True),
            patch(
                "src.api.v1.base.repo_router.get_last_commit_date",
                return_value=datetime.now(timezone.utc).isoformat(),
            ),
    ...
    def test_get_repo_error_status(self, client):
        ...
        with (
            ...
            patch("src.api.v1.base.repo_router.get_last_commit_date", return_value=None),
        ):
...
class TestGitHubApiV1Post:
    ...
    @patch("src.api.v1.base.repo_router.clone_repo")
    ...
    @patch("src.api.v1.base.repo_router.delete_repo")
    ...
    def test_get_repo_tree(self, client):
        ...
        with (
            patch("src.api.v1.base.repo_router._get_repo_path", return_value=mock_path),
            patch("src.api.v1.base.repo_router._is_valid_repo", return_value=True),
            patch(
                "src.api.v1.base.repo_router.get_metadata",
                return_value={"status": "synced"},
            ),
            patch("src.api.v1.base.repo_router.get_selected_dirs", return_value=[]),
            patch(
                "src.api.v1.base.repo_router.list_directory_tree",
    ...
    def test_get_repo_tree_not_found(self, client):
        ...
        with patch("src.api.v1.base.repo_router._get_repo_path", return_value=mock_path):
    ...
    def test_select_dirs_success(self, client):
        ...
        with (
            ...
            patch("src.api.v1.base.repo_router._is_valid_repo", return_value=True),
            patch(
                "src.api.v1.base.repo_router.save_selected_dirs",
...
class TestGitHubApiV1Sync:
    ...
    def test_sync_repo_success(self, client):
        ...
        with (
            ...
            patch(
                "src.api.v1.base.repo_router.update_repo",
    ...
    def test_sync_repo_branch_override(self, client):
        ...
        with (
            ...
            patch("src.api.v1.base.repo_router.update_repo", return_value={"success": True}),
        ):
...
class TestGitHubApiV1ModelValidation:
    ...
    def test_add_repo_branch_default(self, client):
        ...
        with (
            patch(
                "src.api.v1.base.repo_router.clone_repo",
...
class TestMarkSelected:
    ...
    def test_mark_selected_matches(self):
        ...
        from src.api.v1.base.repo_router import _mark_selected
