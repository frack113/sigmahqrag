...
class TestExceptionHandlerIntegration:
    ...
    def test_sigma_error_handler_uses_http_status(self, client: TestClient) -> None:
    ...
    def test_model_not_found_handler_uses_http_status(self, client: TestClient) -> None:
