...
class TestRAGService:
    ...
    @pytest.mark.asyncio
    async def test_add_documents_success(self, rag_service, sample_text_file, mock_llm_service):
...
class TestChatService:
    ...
    @pytest.mark.asyncio
    async def test_chat_without_rag(self, chat_service, mock_llm_service, mock_rag_service):
    ...
    @pytest.mark.asyncio
    async def test_chat_with_rag(self, chat_service, mock_llm_service, mock_rag_service):
        ...
        assert result == "Test response"
        mock_rag_service.query.assert_called_once_with("Test message", n_results=3, min_score=0.1)
