...
class TestLocalEmbeddingService:
    ...
    def test_generate_embeddings_cpu_success(
        self, mock_sentence_transformer, local_embedding_service
    ):
    ...
    @pytest.mark.unit
    @patch("src.core.local_embedding_service.SentenceTransformer")
    def test_generate_embeddings_cpu_empty_input(
        self, mock_sentence_transformer, local_embedding_service
    ):
    ...
    @pytest.mark.unit
    @patch("src.core.local_embedding_service.SentenceTransformer")
    def test_generate_embeddings_cpu_import_error(
        self, mock_sentence_transformer, local_embedding_service
    ):
    ...
    @pytest.mark.unit
    @patch("src.core.local_embedding_service.SentenceTransformer")
    def test_generate_embeddings_with_fallback_cpu_success(
        self, mock_sentence_transformer, local_embedding_service
    ):
        ...
        embeddings = asyncio.run(
            local_embedding_service.generate_embeddings_with_fallback(texts)
        )
    ...
    @patch("src.core.local_embedding_service.SentenceTransformer")
    @patch("requests.post")
    def test_generate_embeddings_with_fallback_api_fallback(
        self, mock_requests_post, mock_sentence_transformer, local_embedding_service
    ):
    ...
    @patch("src.core.local_embedding_service.SentenceTransformer")
    @patch("requests.post")
    def test_generate_embeddings_with_fallback_both_fail(
        self, mock_requests_post, mock_sentence_transformer, local_embedding_service
    ):
        ...
        with pytest.raises(Exception):
            asyncio.run(
                local_embedding_service.generate_embeddings_with_fallback(
                    texts, use_fallback=True
                )
            )
