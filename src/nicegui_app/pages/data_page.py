        ...
        with ui.row().classes("w-full flex-1 gap-4 p-4"):
            ...
            with ui.card().classes("flex-1 p-4"):
                ...
                with self.repo_container:
                    ui.label("Loading repository information...").classes("text-sm text-gray-600")
    ...
    def _update_statistics(self, stats: dict):
        ...
        if self.stats_container:
            ...
            with self.stats_container:
                ...
                ui.label(f"Chunk Overlap: {chunk_overlap} characters").classes("text-sm")
            ...
            with self.repo_container:
                ...
                if repo_config:
                    ...
                    for repo in repo_config:
                        status_color = "text-green-600" if repo.enabled else "text-gray-500"
        ...
        try:
            ...
            with concurrent.futures.ThreadPoolExecutor(max_workers=2) as executor:
                ...
                try:
                    ...
                    self.progress_notification.message = "Repository cloning timed out. Please try again."
                    self.progress_notification.spinner = False
            ...
            with concurrent.futures.ThreadPoolExecutor(max_workers=2) as executor:
                ...
                try:
                    ...
                    self.progress_notification.message = "Indexing timed out. Please try again."
                    self.progress_notification.spinner = False
                    await asyncio.sleep(3)
                    self.progress_notification.dismiss()
                    return
