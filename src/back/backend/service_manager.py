...
class ServiceManager:
    ...
    async def start_qdrant(
        ...
        Args:
            ...
            config_path: Path to qdrant.yaml config file
        ...
        # On Windows, check for .exe inside directory or as sibling
        if qdrant_path.is_dir():
            exe_in_dir = qradnt_path / "qdrant.exe"
        ...
        pid_file = self.pid_dir / "qdrant.exe" # Wait, this should be .pid
        # ...
