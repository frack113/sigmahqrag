...
import gradio as gr
from src.models.logging_service import get_logger, logging_service
...
class LogsViewer(AsyncComponent):
    ...
    async def _load_initial_logs(self):
        ...
        try:
            ...
            # Return default values if UI components not yet created
    ...
    async def _refresh_logs(self, filter_text: str, level_filter: str) -> tuple:
        ...
        try:
            ...
            if self.logs_display and self.line_count_label:
                ...
                return "Loading...", "0 lines", self.status_text, self._generate_log_info()
