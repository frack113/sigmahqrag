...
class ChatInterface(AsyncComponent):
    ...
    def _handle_send_message(self, message: str, history: list[dict[str, str]]) -> tuple[list[dict[str, str]], str]:
        ...
        try:
            ...
            self.chat_service.add_message_to_history("default", "assistant", full_response)
    ...
    async def _handle_command(self, command: str, history: list[dict[str, str]]) -> AsyncGenerator[tuple[list[dict[str, str]], str], None]:
...
- Error handling and retry logic"""
            ...
            history.append({"role": "assistant", "content": "Unknown command. Type /help for available commands."})
...
- Error Rate: Low"""
    ...
    async def _clear_chat(self) -> tuple[list[dict[str, str]], str]:
        ...
        try:
            ...
            self.chat_service.add_message_to_history("default", "assistant", welcome_msg)
        ...
        try:
            ...
            if existing_messages:
                ...
                if history and history[-1]["role"] == "user":
                    ...
                    self.chat_service.add_message_to_history("default", "assistant", incomplete_msg)
