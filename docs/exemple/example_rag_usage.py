...
def test_specialized_rag_services():
    ...
    long_document = {
        "id": "long_doc",
        "content": "This is a very long document about advanced programming concepts. " * 20 + 
                  "It covers topics like algorithms, data structures, design patterns, and software architecture. " * 10 +
